...
const OAUTH_ERRORS: Record<string, string> = {
  not_registered: 'No admin account exists for that Google email. Ask a super-admin to invite you first.',
  wrong_portal:   'That Google account is registered but not as an admin. Use the matching portal instead.',
  inactive:       'Your admin account is inactive or suspended. Contact a super-admin.',
};
...
export const LoginPage = () => {
  ...
  // Already-signed-in admin landed on /login (browser back, manual URL, etc.)
  ...
  const signInWithGoogle = () => {
    ...
    window.location.href = `${API_BASE}/auth/google?portal=admin&returnTo=${returnTo}&origin=${origin}`;
  };
